...
public class Vehiculo extends Peaje{
    ...
    public void cargar(double peso) throws CamionException{
        if(peso > 0 && (peso+cargaActual) <= (cargaMaxima)   ){
            ...
            throw new CamionException("No hay nada en el camion");
        }else{
            throw new CamionException("Superaste la carga maxima.");
        }
    }
